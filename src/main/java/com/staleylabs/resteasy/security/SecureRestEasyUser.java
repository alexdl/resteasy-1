...
/**
 * Referenced from {@link org.springframework.security.core.userdetails.User} to include the organization ID.
 *
 * @author Sean M. Staley
 * @version 1.0 (8/31/13)
 */

public class SecureRestEasyUser implements UserDetails {
    ...
    public boolean equals(Object rhs) {
        if (rhs instanceof SecureRestEasyUser) {
            return username.equals(((SecureRestEasyUser) rhs).username);
        }
        return false;
    }
