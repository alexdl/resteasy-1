    ...
    <form:form id="createUserForm" commandName="registering-user-entity" action="/api/user/create" method="POST">
        ...
        <div class="tab-content">
            ...
            <div id="personal" class="tab-pane">
                ...
                <table id="personalTable" class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <form:input id="addressLine1" type="text" autocomplete="off" class="input-xxlarge"
                    ...
                    <tr>
                        <td></td>
                        <td colspan="2">
                            <form:input id="addressLine2" type="text" autocomplete="off" class="input-xxlarge"
            ...
            <div id="organization" class="tab-pane">
                ...
                <label>Address:</label>
                <form:input id="orgAddressLine1" type="text" class="input-large" path="organizationAddressLine1"
                            placeholder="1100 N Anchor Way"/>
                <form:input id="orgAddressLine2" type="text" path="organizationAddressLine2"
                            placeholder="Suite 402"/>
                <form:input id="orgCity" type="text" path="organizationCityName" placeholder="Seattle"/>
                <form:input id="orgStateCode" type="text" path="organizationStateCode" placeholder="WA"/>
                <form:input id="orgZipCode" type="text" path="organizationPostalCode" placeholder="92193"/>
            </div>
            ...
            <div id="review" class="tab-pane">
                ...
                <label>Closed Beta! Must enter a code to create a username!</label>

                <input id="promotionalCode" type="text" class="input-medium" placeholder="Enter Promo Code">
                <button id="promotionalCodeButton" class="btn btn-mini btn-info">Check</button>

                <form:button type="submit" class="btn btn-primary disabled">Create</form:button>
            </div>
        </div>
    </form:form>
</div>
